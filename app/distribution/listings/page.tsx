...
const LISTINGS: Listing[] = [
  ...
  { id: '10', productId: 'PRD-010', productName: 'Bitflow Data Stream', icon: 'ri-flow-chart', iconColor: 'violet', salesChannel: 'Horizon Cloud Market', startingPrice: 32.00, status: 'Inactive' },
  { id: '11', productId: 'PRD-011', productName: 'InvoiceNinja Billing', icon: 'ri-bill-line', iconColor: 'red', salesChannel: 'Apex Cloud Store', startingPrice: 14.99, status: 'Active' },
  { id: '12', productId: 'PRD-012', productName: 'Cloudspark Secure Connect', icon: 'ri-shield-check-line', iconColor: 'teal', salesChannel: 'Meridian Commerce', startingPrice: 18.00, status: 'Active' },
  ...
  { id: '14', productId: 'PRD-014', productName: 'DataVault Backup Pro', icon: 'ri-database-2-line', iconColor: 'orange', salesChannel: 'Apex Cloud Store', startingPrice: 22.00, status: 'Active' },
  ...
  { id: '22', productId: 'PRD-022', productName: 'FormStack Builder', icon: 'ri-layout-grid-line', iconColor: 'pink', salesChannel: 'Vertex Cloud Exchange', startingPrice: 14.00, status: 'Inactive' },
  { id: '23', productId: 'PRD-023', productName: 'Bitflow Data Stream', icon: 'ri-flow-chart', iconColor: 'violet', salesChannel: 'Nimbus CRM Exchange', startingPrice: 35.00, status: 'Active' },
  { id: '24', productId: 'PRD-024', productName: 'DataVault Backup Pro', icon: 'ri-database-2-line', iconColor: 'orange', salesChannel: 'Stratosphere Marketplace', startingPrice: 21.00, status: 'Inactive' },
  { id: '25', productId: 'PRD-025', productName: 'InvoiceNinja Billing', icon: 'ri-bill-line', iconColor: 'red', salesChannel: 'Presto Growth Hub', startingPrice: 16.99, status: 'Active' },
];
