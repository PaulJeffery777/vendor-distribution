...
const ORDERS: Order[] = [
  ...
  { id: '2', orderId: 'ORD-10002', date: '2026-05-27', customer: 'Northstar Logistics Inc', salesChannel: 'Apex Cloud Store', amount: 8750.00, status: 'Unfulfilled', items: 1 },
  { id: '3', orderId: 'ORD-10003', date: '2026-05-27', customer: 'Cascade Financial Group', salesChannel: 'Horizon Cloud Market', amount: 1200.00, status: 'Fulfilled', items: 2 },
  { id: '4', orderId: 'ORD-10004', date: '2026-05-26', customer: 'Brightpath Education', salesChannel: 'Meridian Commerce', amount: 450.00, status: 'Cancelled', items: 1 },
  ...
  { id: '6', orderId: 'ORD-10006', date: '2026-05-25', customer: 'Pinnacle Real Estate', salesChannel: 'Apex Cloud Store', amount: 999.00, status: 'Fulfilled', items: 1 },
  { id: '7', orderId: 'ORD-10007', date: '2026-05-25', customer: 'Ironclad Security Ltd', salesChannel: 'Horizon Cloud Market', amount: 5400.00, status: 'Fulfilled', items: 4 },
  { id: '8', orderId: 'ORD-10008', date: '2026-05-24', customer: 'Summit Analytics Corp', salesChannel: 'Stratosphere Marketplace', amount: 1875.00, status: 'Unfulfilled', items: 2 },
  ...
  { id: '10', orderId: 'ORD-10010', date: '2026-05-23', customer: 'Apex Consulting Group', salesChannel: 'Meridian Commerce', amount: 12500.00, status: 'Fulfilled', items: 8 },
  { id: '11', orderId: 'ORD-10011', date: '2026-05-23', customer: 'Redstone Energy Partners', salesChannel: 'Vertex Cloud Exchange', amount: 3600.00, status: 'Unfulfilled', items: 3 },
  { id: '12', orderId: 'ORD-10012', date: '2026-05-22', customer: 'Bluewave Media Group', salesChannel: 'Apex Cloud Store', amount: 750.00, status: 'Cancelled', items: 1 },
  { id: '13', orderId: 'ORD-10013', date: '2026-05-22', customer: 'Orion Tech Solutions', salesChannel: 'Nimbus CRM Exchange', amount: 4200.00, status: 'Fulfilled', items: 2 },
  { id: '14', orderId: 'ORD-10014', date: '2026-05-21', customer: 'Tidewater Shipping LLC', salesChannel: 'Horizon Cloud Market', amount: 1950.00, status: 'Unfulfilled', items: 3 },
  { id: '15', orderId: 'ORD-10015', date: '2026-05-21', customer: 'Prism Design Studio', salesChannel: 'Presto Growth Hub', amount: 320.00, status: 'Fulfilled', items: 1 },
  ...
  { id: '17', orderId: 'ORD-10017', date: '2026-05-20', customer: 'Steelbridge Construction', salesChannel: 'Meridian Commerce', amount: 560.00, status: 'Cancelled', items: 1 },
  { id: '18', orderId: 'ORD-10018', date: '2026-05-19', customer: 'Quantum Data Systems', salesChannel: 'Apex Cloud Store', amount: 2100.00, status: 'Unfulfilled', items: 2 },
  { id: '19', orderId: 'ORD-10019', date: '2026-05-19', customer: 'Horizon Aerospace Inc', salesChannel: 'Stratosphere Marketplace', amount: 15000.00, status: 'Fulfilled', items: 10 },
  { id: '20', orderId: 'ORD-10020', date: '2026-05-18', customer: 'Cornerstone Legal Partners', salesChannel: 'Vertex Cloud Exchange', amount: 890.00, status: 'Unfulfilled', items: 1 },
  { id: '21', orderId: 'ORD-10021', date: '2026-05-18', customer: 'Frostbyte Cybersecurity', salesChannel: 'Horizon Cloud Market', amount: 6300.00, status: 'Fulfilled', items: 4 },
  { id: '22', orderId: 'ORD-10022', date: '2026-05-17', customer: 'Evergreen Supply Chain', salesChannel: 'Nimbus CRM Exchange', amount: 1100.00, status: 'Fulfilled', items: 2 },
  ...
  { id: '24', orderId: 'ORD-10024', date: '2026-05-16', customer: 'Silverpeak Ventures', salesChannel: 'Presto Growth Hub', amount: 280.00, status: 'Cancelled', items: 1 },
  { id: '25', orderId: 'ORD-10025', date: '2026-05-16', customer: 'Cobalt Pharmaceuticals', salesChannel: 'Meridian Commerce', amount: 9200.00, status: 'Fulfilled', items: 7 },
];

const CHANNELS = ['AppDirect', 'Apex Cloud Store', 'Horizon Cloud Market', 'Meridian Commerce', 'Vertex Cloud Exchange', 'Nimbus CRM Exchange', 'Presto Growth Hub', 'Stratosphere Marketplace'];
